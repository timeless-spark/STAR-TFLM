...
#if defined(STAR) || defined(FC_SCALE_PER_CHANNEL)
extern const int kFullyConnectedQuantizedDimension;
#endif
...
#ifdef STAR
// Returns a TfLiteRegistration struct for kernel variant that
// exploit special RISC-V ISA extension for STAR operations
