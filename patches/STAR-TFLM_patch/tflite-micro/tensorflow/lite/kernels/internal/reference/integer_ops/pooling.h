...
bool __attribute__((noinline)) AveragePool(const PoolParams& params,
...
void __attribute__((noinline)) MaxPool(const PoolParams& params, const RuntimeShape& input_shape,
